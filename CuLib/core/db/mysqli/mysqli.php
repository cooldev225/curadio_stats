<?PHP
include "tables.php";
$mysqli = new cug__mysqli($db_host, $db_user, $db_password, $db_name, $db_server_port, $db_server_key, $db_server_cert, $db_ca_cert);
$mysqli_cache = new cug__mysqli($db_host, $db_user, $db_password, $db_cache_name, $db_server_port, $db_server_key, $db_server_cert, $db_ca_cert);
 ...
 class cug__mysqli extends mysqli 
{
	 ...
	 * @access	public
	 */
	 public function __construct($db_host, $db_user, $db_password, $db_name, $server_port=NULL, $server_key=NULL, $server_cert=NULL, $ca_cert=NULL) 
	{	
	$port = (!empty($server_port)) ? $server_port : 3306;
	self::init();

		 if(!empty($server_key) && !empty($server_cert) && !empty($ca_cert))  // SSL
		{ 
