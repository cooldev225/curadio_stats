...
switch($ACTION) {
	...
	//********************************
	 ...
	 //********************************
	     ...
	     //get data
	     $data = cug_rms_stat_get_data_by_object("MEMBER", $member_ids['cugate_member_id'], $member_ids['shenzhen_member_id'], $time_period, $limit=3, $amounts);
	     //print_r($data);
	 ...
	 //********************************
	     ...
	     //get data
	     $data = cug_rms_stat_get_data_by_object("LABEL", $label_ids['cugate_label_id'], $label_ids['shenzhen_label_id'], $time_period, $limit=3, $amounts);
	     //print_r($data);
	 ...
	 //********************************
	  ...
	  //********************************
	      ...
	      //get data
	      $data = cug_rms_stat_get_data_by_object("PUBLISHER", $publisher_ids['cugate_publisher_id'], $publisher_ids['shenzhen_publisher_id'], $time_period, $limit=3, $amounts);
	      //print_r($data);
